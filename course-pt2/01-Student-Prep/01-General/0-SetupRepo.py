...
# MAGIC     - Select Workspace -> Repos, or create a folder. Press `Create` button, and select `Git Folder`. Paste in the path to your fork of the repo https://github.com/foobar123456/databricks-dataops-course. It will automatically fill out the other fields. Press `Create Git folder`.
